...
<body style="background-color:#ffdf80">
    ...
    <h4 style="text-align:center">First name: <?php echo $final_first ?> <a href="change_fname.html"><button>Change First Name</button></a></h4>
    ...
    <p></p>
    <a href="changepass.html" style="text-decoration:none"><button style="display:block;margin:0 auto">Change Password</button></a>
