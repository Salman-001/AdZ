...
<div class="header">
		<div class="container">
			<div class="logo">
				<a href="index.php">ADZ </a> <span>Real Estate</span>
			</div>
				...
				<div class="search-product ads-list">
					...
					<div class="search">
						...
						<div class="input-group">
							<form action="searchrealestate.php" method="GET">
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							...
							<ul class="list">
                                ...
                                $sql = "SELECT * FROM query_view WHERE category_id=3 OR category_id=4";
						...
						<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						 <div>
							...
							<?php
                                ...
                                $sql = "SELECT * FROM PRODUCTS WHERE category_id=3 OR category_id=4";
                                $result = $connection->query($sql);
