...
$my_id_query = $connection->prepare("SELECT user_id FROM users WHERE username=? or email=?");
$my_id_query->bind_param("ss", $_SESSION["input"], $_SESSION["input"]);
$my_id_query->execute();

$my_id_result = $my_id_query->get_result();

$my_id_row = $my_id_result->fetch_assoc();

$my_id_json = json_encode($my_id_row);

$my_id = (int) filter_var($my_id_json, FILTER_SANITIZE_NUMBER_INT);
					  ...
					  <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						<li role="presentation" class="active">
						  <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
							<span class="text">All My Ads</span>
						  </a>
						</li>
					  </ul>
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							...
							<ul class="list">
                                ...
                                $sql = "SELECT * FROM query_view WHERE user_id=\"$my_id\"";
						...
						<div class="col-md-3 footer-grid">
							...
							<address>
								<ul class="location">
									...
									<li>Beirut Mallah Building</li>
									<div class="clearfix"></div>
								</ul>	
								<ul class="location">
									<li><span class="glyphicon glyphicon-earphone"></span></li>
									<li>+961 76 83 66 33</li>
									<div class="clearfix"></div>
								</ul>	
								<ul class="location">
									<li><span class="glyphicon glyphicon-envelope"></span></li>
									<li><a href="mailto:adzforlebanon@outlook.com">adzforlebanon@outlook.com</a></li>
									<div class="clearfix"></div>
								</ul>						
							</address>
						</div>
